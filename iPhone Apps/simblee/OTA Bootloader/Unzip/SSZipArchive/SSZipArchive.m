	...
	do {
		@autoreleasepool {
	            ...
	            if (fp) {
	                ...
	                if (fileInfo.dosDate != 0) {
	                    ...
	                    if (attr) {
	                        if ([fileManager setAttributes:attr ofItemAtPath:fullPath error:nil] == NO) {
	                            ...
	                            DLog(@"[SSZipArchive] Failed to set attributes - whilst setting modification date");
	                        }
	                    }
	                }
                    ...
                    if (permissions != 0) {
                        ...
                        if ([fileManager setAttributes:attrs ofItemAtPath:fullPath error:nil] == NO) {
                            ...
                            DLog(@"[SSZipArchive] Failed to set attributes - whilst setting permissions");
                        }
            ...
            else
            {
                ...
                if(symlinkError != 0)
                {
                    DLog(@"Failed to create symbolic link at \"%@\" to \"%@\". symlink() error code: %d", fullPath, destinationPath, errno);
                }
            }
