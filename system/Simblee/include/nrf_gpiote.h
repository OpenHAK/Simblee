...
{
    // this pan issue is resolved as of xlr2, and the code below is no longer needed (and problematic, since pin 31 on simblee enables whisper mode)
    ...
    //     // smp: pin 31 on Simblee enables whisper mode, moving to pin 30
    //     NRF_GPIOTE->CONFIG[channel_number] = (GPIOTE_CONFIG_MODE_Task       << GPIOTE_CONFIG_MODE_Pos)     |
    //                                          (30UL                          << GPIOTE_CONFIG_PSEL_Pos)     |
