...
void setup()
{
  ...
  SimbleeGZLL.hostBaseAddress = 0x12345678;    // default host base address is 0x0D0A0704;
  SimbleeGZLL.deviceBaseAddress = 0x87654321;  // default device base address is 0x0E0B0805;
