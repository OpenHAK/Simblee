...
reduce the power consumption of the Simblee.
...
void loop() {
  ...
  // SimbleeBLE_update_conn_interval(900,1000);
  
  // display the connection interval the iPhone actually selected after a button press
  int connInterval = SimbleeBLE.getConnInterval();
...
void SimbleeBLE_onConnect()
{
  ...
  SimbleeBLE.updateConnInterval(900, 1100);

  // note: you cannot use delay()/SimbleeBLE.getConnInterval() here to determine which
