...
#define LOW 0
#define HIGH 1
//#define CHANGE 2 //change not supported
#define FALLING 0   //changed FALLING to LOW
#define RISING 1    //changed RISING to HIGH
...
#define VDD2_3_PS			ADC_CONFIG_INPSEL_SupplyTwoThirdsPrescaling				// Supply voltage with 2/3 prescaling used as input for the conversion
#define VDD1_3_PS			ADC_CONFIG_INPSEL_SupplyOneThirdPrescaling				// Supply voltage with 1/3 prescaling used as input for the conversion
