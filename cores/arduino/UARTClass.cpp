...
{
  begin( dwBaudRate, UART_DEFAULT_RX_PIN, UART_DEFAULT_TX_PIN, UART_DEFAULT_CTS_PIN, UART_DEFAULT_RTS_PIN );
}

void UARTClass::begin( const uint32_t dwBaudRate, uint8_t rx_pin, uint8_t tx_pin )
{
  begin( dwBaudRate, rx_pin, tx_pin, UART_DEFAULT_CTS_PIN, UART_DEFAULT_RTS_PIN );
}

void UARTClass::begin( const uint32_t dwBaudRate, uint8_t rx_pin, uint8_t tx_pin, uint8_t cts_pin, uint8_t rts_pin )
{
  transmitting = false;
  UART0_Start( dwBaudRate, rx_pin, tx_pin, cts_pin, rts_pin );
}
